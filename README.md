...
Especificación DynamoDB auditada. La fundación del monorepo, Next.js, la infraestructura base con AWS CDK y el modelo físico inicial de DynamoDB están implementados hasta `TASK-010`, incluido el build serverless real de OpenNext. No existen recursos AWS desplegados.
...
Implementar `TASK-011`, tabla, índices y configuración On-Demand mediante CDK, siempre una tarea por vez conforme a `AGENTS.md`.
